...
#define STRING_CONFIG_H_AUTHOR "(scrith, Ender-3 Pro)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Alonzo"
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 223.0
  #define DEFAULT_bedKi 43.63
  #define DEFAULT_bedKd 759.9
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 922 }
...
//conflicts with PREHEAT_BEFORE_LEVELING, only use one
...
// printable bed size is reduced because of new hotend

// Service position
#define X_SERVICE_POS 115
#define Y_SERVICE_POS 110
...
#define MIN_SOFTWARE_ENDSTOPS
  ...
  //#define MIN_SOFTWARE_ENDSTOP_Z // Allow movement beyond the z-stop for probe-based mesh leveling
...
//conflicts with PREHEAT_BEFORE_PROBING, only use one
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS), (Y_MAX_POS), 30 }
